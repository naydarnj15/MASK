...
PlayGame.prototype.update = function () {
    if (this.game.click && this.game.car.collide < 15) this.game.running = true;
}
...
PlayGame.prototype.draw = function (ctx) {
    ...
    if (this.game.car.collide <= 15) {
        ...
        } else if (this.game.car.missionComplete && !this.game.car.foundCop) {
            //console.log(this.game.car.missionComplete);
            ctx.fillText("You have completed the first mission. For second mission use one of the cars in", this.x + 27, this.y - 290);
            ctx.fillText("this parking lot to find police and bring it back to the spot.", this.x + 70, this.y - 260);

        }else if (this.game.car.missionComplete2) {
            //console.log(this.game.car.missionComplete);
            ctx.fillText("Congratulation, You have won the game!", this.x + 70, this.y - 200);
...
Car.prototype.update = function (ctx) {
    ...
    var carname2 = str.substring(str.length -7);
    ...
    }if (carname2 === 'cop.png' && this.missionComplete) {
        //console.log(carname);
        this.foundCop = true;
        if (this.game.Background.curTile.col === 1 && this.game.Background.curTile.row === 0) {
            this.missionComplete2 = true;
...
ASSET_MANAGER.downloadAll(function () {
    ...
    parkedCars = [
        new Car2(gameEngine, 590, 788,ASSET_MANAGER.getAsset("./img/mercedes.png"), {row:0, col:1},116,54, 0),
                    ...
                    new Car2(gameEngine, 5570, 3815,ASSET_MANAGER.getAsset("./img/cop.png"), {row:3, col:4}, 116,54, 270), 
